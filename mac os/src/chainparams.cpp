...
public:
    CMainParams()
    {
        ...
        vSeeds.push_back(CDNSSeedData("95.216.236.194", "95.216.236.194"));
        vSeeds.push_back(CDNSSeedData("136.243.63.194", "136.243.63.194"));
        vSeeds.push_back(CDNSSeedData("188.40.174.97", "188.40.174.97"));
		vSeeds.push_back(CDNSSeedData("173.249.39.4", "173.249.39.4"));
