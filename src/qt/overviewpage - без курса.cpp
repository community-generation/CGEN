                                              ...
                                              filter(0)
{
    ...
    ui->pushButton_Reddit->setIcon(QIcon((":/icons/reddit")));
    ui->pushButton_Reddit->setStatusTip(tr("Read ESBC reddit"));
    ui->pushButton_Medium->setIcon(QIcon((":/icons/medium")));
    ui->pushButton_Medium->setStatusTip(tr("Read ESBC Medium"));
    ui->pushButton_Medium2->setIcon(QIcon((":/icons/medium")));
    ui->pushButton_Medium2->setStatusTip(tr("Read ESBC Medium"));
...
void OverviewPage::on_pushButton_Medium2_clicked() {
    QDesktopServices::openUrl(QUrl("https://esbc.pro/link/explorer", QUrl::TolerantMode));
}